# PowerShell script to get a snapshot (C:\Users\Spencer\AndroidStudioProjects\Fawna\DEVOPS\SCRIPTS\get_snapshot.ps1)
...
$FileExtensions = @("kt", "java", "xml", "gradle", "properties", "pro")

# Files and folders to ignore
$IgnoreFiles = @("local.properties")
$IgnoreFolders = @(".gradle", "build")
...
$CollectedText = Get-TextFromFiles -BasePath $rootDir -Extensions $FileExtensions -IgnorePatterns $IgnorePatterns -IgnoreFiles $IgnoreFiles -IgnoreFolders $IgnoreFolders
